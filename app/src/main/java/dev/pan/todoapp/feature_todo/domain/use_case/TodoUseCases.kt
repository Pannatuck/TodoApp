package dev.pan.todoapp.feature_todo.domain.use_case

import dev.pan.todoapp.core.util.TodoUseCaseStrings
import dev.pan.todoapp.feature_todo.domain.model.TodoItem
import dev.pan.todoapp.feature_todo.domain.repo.TodoListRepo
import dev.pan.todoapp.feature_todo.domain.util.InvalidTodoItemException
...
class TodoUseCases @Inject constructor(
    ...
    suspend fun getTodoItems(
        ...
        return when (todoItemOrder.sortingDirection){
            ...
            // TODO: else return TodoUseCaseResult.Error()???
        }
    }
